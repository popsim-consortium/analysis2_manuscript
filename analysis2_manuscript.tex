...
\section*{Introduction}
    ...
    to model all of these features simultaneously using estimates/annotations obtained
...
\section*{Implementing Selection in \stdpopsim}
    ...
    occurring outside of these regions are fitness neutral.
...
%    and the detection of selective sweeps, particularly in the context of realistic recombination maps and background selection.
    ...
    which in the case of negative selection is commonly referred to as \emph{background selection} \citep{charlesworth1993effect,hudson1995deleterious}, 
...
\section*{Estimation of the Distribution of Fitness effects}
    ...
    while \grapes under-estimates the fraction of mutations with $-1<s<-0.01$ and considerably over-estimates the fraction of
