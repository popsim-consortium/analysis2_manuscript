...
\author[2,19,*]{Murillo F. Rodrigues}
...
\author[12]{Georgia Tsambos}
\author[10]{Yan Wong}
\author[13]{Yu Zhang}

% PI additional authors
\author[14]{Christian D. Huber}
\author[13]{Gregor Gorjanc}
\author[15]{Aaron P. Ragsdale}
...
\author[17]{Daniel R. Schrider}
\author[2,18]{Peter L. Ralph}
...
\affil[12]{\small{Department of Genome Sciences, University of Washington, Seattle WA, USA}}
\affil[13]{\small{The Roslin Institute and Royal (Dick) School of Veterinary Studies, University of Edinburgh, Edinburgh EH25 9RG, UK}}
\affil[14]{\small{Department of Biology, Pennsylvania State University, University Park, PA 16802, USA}}
\affil[15]{\small{Department of Integrative Biology, University of Wisconsin-Madison, Madison WI, USA}}
\affil[16]{\small{Efi Arazi School of Computer Science, Reichman University, Herzliya 4610101, Israel}}
\affil[17]{\small{Department of Genetics, University of North Carolina at Chapel Hill, Chapel Hill NC 27599, USA}}
\affil[18]{\small{Department of Data Science, University of Oregon, Eugene OR 97402, USA}}
\affil[19]{\small{Division of Genetics, Oregon National Primate Center, Oregon Health and Science University, Beaverton OR 97006, USA}}
...
\section*{Abstract}
    ...
    of natural selection, including background selection, selective sweeps,
...
\section*{Introduction}
    ...
    The project also promotes open, collaborative, and inclusive work,
...
\section*{Implementing Selection in \stdpopsim}
    ...
    Thus, this particular parameterization of background selection and demographic model,
...
\section*{Estimation of the Distribution of Fitness effects}
    ...
    To allow direct comparison, here we have normalized all inference results to the convention of \slim
    ...
    Overall, inferred DFEs varied across populations and inference methods (Figure \ref{fig:homsap-dfe.ooa}). %, Table \ref{tab:dfe_table}). IG: Table seems less relevant here
...
\section*{Detection of Selective Sweeps}
    ...
    \begin{figure}[b!]
        ...
        \sweepfinder (top row -- labelled CLR),
...
\section*{Discussion}
    ...
    in power were observed when applying a method to genomes simulated with different demographic histories (YRI versus CEU)
...
\section*{Methods}
    ...
    For \msmc %\citep{Schiffels2020}, IG: no need to double-cite
...
\begin{figure}[h]
    ...
    Genetic diversity in vaquite simulations.
    Nucleotide diversity ($\pi$) was calculated for genomes simulated
