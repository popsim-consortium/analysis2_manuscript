...
\section*{Implementing Selection in \stdpopsim}
    ...
    by defining ranges of selection coefficients and associating each range with a different dominance coefficient (see below). \revpoint{1}{5}
...
\section*{Estimation of the Distribution of Fitness effects}
    ...
    has recovered the true DFE (Figure \ref{fig:homsap-dfe.ooa}C). \revpoint{2}{3}
...
\section*{Discussion}
    ...
    show a similar fit to the SFS and may be more biologically realistic than fully additive models, \revpoint{1}{7}
...
\section*{Methods}
    ...
    \subsection*{The DFE Class}
    \revpoint{1}{5}
    The DFE class has the following attributes for modeling natural selection in a given set of annotated genomic segments.
    TBA
...
\begin{figure}[h]
    ...
    Here we show the results of $\pi$ computed across all three populations (CEU, CHB, YRI)
    taken together (i.e., not separately for each population).
