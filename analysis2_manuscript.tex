...
\section*{Estimation of the Distribution of Fitness effects}
    ...
    \footnote{
    A challenge in comparing inferences among DFE inference tools is differing factors of two in definitions.
    The simulator SLiM defines the selection coefficient $s$ such that a homozygote has fitness $1+s$.
    dadi and PolyDFE (https://academic.oup.com/genetics/article/207/3/1103/5930676) define the selection coefficient such that a homozygote has fitness $1+ 2s$.
    GRAPES  is like SLiM.
    
    Even more confusingly, dadi infers the distribution of the population-scaled selection coefficient $2 N_e s$ (fitdadi paper).
    PolyDFE infers the distribution of $4 Ne s$ (https://academic.oup.com/genetics/article/207/3/1103/5930676).
    And GRAPES infers the distribution of $4 Ne s$ (https://academic.oup.com/genetics/article/216/2/559/6066183).}
