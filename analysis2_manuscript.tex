...
\section*{Detection of Selective Sweeps}
    ...
    This is somewhat surprising given that background selection is expected to somewhat interfere with the sweep signature (reviewed by \citet{stephan2010genetic}).
