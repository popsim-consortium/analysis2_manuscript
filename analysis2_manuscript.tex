...
\section*{Example Applications with Selection}
    ...
    although GONE seems to overestimate $N_e(t)$ for the CHB sample and to a lesser extent in the CEU sample. #ADK: is GONE time scaled incorrectly? i.e. gens not years?
...
\section*{Detection of Selective Sweeps}
    ...
    in these genomic regions at least, but that it lags behind \diploshic and \sweepfinder2 in terms of accuracy in the YRI sample.
