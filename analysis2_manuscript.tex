...
\section*{Methods}
    ...
    We note in passing that aggressive scaling of forward-in-time simulations
    can lead to quite different outcomes when selection in involved \cite{dabi2025population},
