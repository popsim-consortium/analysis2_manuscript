...
where we have simulated genomes under a three-population model of human out of Africa (OOA) demography
...
from each independent population in the three-population model of human OOA demography (CEU, CHB, and YRI from left to right).
...
from a model with selection.  We see that all methods perform well in the absence of selection, but that the presence
