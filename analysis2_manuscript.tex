...
\section*{Detection of Selective Sweeps}
    ...
    \begin{figure}[t!]
        ...
        1) \sweepfinder \citep{degiorgio2016sweepfinder2} (top row -- labelled CLR),
    ...
    Note, however, that despite the apparent good performance of the $\pi$ statistic,
    it showed extreme heterogeneity across the genome. % MFR: I think this is an important point. Basically there is a Simpson's paradox here.
...
\begin{figure}
    ...
    under BGS applied on exons with the same demographic history and genetic map
    used in the simulations that included sweeps (see \textbf{Methods}).
    AUC scores are shown for each method. \sweepfinder is labelled CLR in the figure.
    }
