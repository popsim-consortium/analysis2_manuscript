...
\section*{Methods}
    ...
    mutation with a fitness effect of $h s$ where $h$ is the dominance
    coefficient (as for the DFE model) and $s \geq 0$ is the selection
    ...
    allele drifts out of the population of origin. The conditioning may
