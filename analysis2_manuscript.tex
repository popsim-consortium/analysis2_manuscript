...
from four software packages for inferring the DFE from genetic data-- 
dadi \citep{gutenkunst2009inferring}, polyDFE \citep{tataru2020polydfe}, 
DFE-alpha \citep{eyre2009estimating}, and GRAPES \citep{galtier2016adaptive}. 
...
perform slightly worse that the other methods, and polyDFE slightly better. %ADK-- maybe we move constant size to the supplement?
...
%ADK-- want to add a new figure here that simply compares relative MSE among
% methods for each parameter in each population
    ...
    \begin{figure}
        ...
        acting on exons parameterized by a mean selection coefficient and a shape parameter. On each row we show the true parameter
        as a red line, and the estimates as boxplots from replicate simulations. The vaquita model has a single population with a recent
        bottleneck. Each row of the figure shows estimates from a different method: 1) dadi \citep{gutenkunst2009inferring}, 2) polyDFE \citep{tataru2020polydfe},
        3) DFE-alpha \citep{eyre2009estimating}, and 4) GRAPES \citep{galtier2016adaptive}.}
    \end{figure}

\section*{Detection of Selective Sweeps}
    \label{sweeps}
    Finally, we show how the new models of selection in \stdpopsim can be used to benchmark and compare
    the performance of different methods for detecting selective sweeps from genetic data. 
    Here we have performed simulations using the human and vaquita porpoise models described above, with complex demographic histories and models of selection acting on exons.
    To remind the reader, the model of selection in each case is a Gamma distributed DFE for deleterious mutations.
...
\centering
\small
\caption{\bf{Performance of DFE methods across the simulation scenerios}. 
...
\hline
\hline
0.001152 & 0.029568 & dadi & HomSap & Constant & exon \\
0.002667 & \bf{0.000712} & dadi & HomSap & Constant & all\_sites \\
\bf{0.000807} & 0.008626 & grapes & HomSap & Constant & exon \\
0.004931 & 0.028638 & grapes & HomSap & Constant & all\_sites \\
0.001773 & 0.014414 & polyDFE & HomSap & Constant & all\_sites \\
0.002344 & 0.006828 & polyDFE & HomSap & Constant & exon \\
0.011556 & 0.026502 & dadi & HomSap & OOA\_5R19 & all\_sites \\
0.013851 & 0.030905 & dadi & HomSap & OOA\_5R19 & exon \\
0.004859 & 0.051345 & grapes & HomSap & OOA\_5R19 & exon \\
0.007921 & 0.055497 & grapes & HomSap & OOA\_5R19 & all\_sites \\
0.007188 & 0.024394 & polyDFE & HomSap & OOA\_5R19 & exon \\
0.007422 & 0.035366 & polyDFE & HomSap & OOA\_5R19 & all\_sites \\
0.024292 & 0.209159 & dadi & PhoSin & Constant & all\_sites \\
0.024365 & 0.233357 & dadi & PhoSin & Constant & exons \\
0.023567 & 0.250249 & grapes & PhoSin & Constant & exons \\
0.023853 & 0.235067 & grapes & PhoSin & Constant & all\_sites \\
0.024439 & 0.234464 & polyDFE & PhoSin & Constant & exons \\
0.024476 & 0.187955 & polyDFE & PhoSin & Constant & all\_sites \\
0.024136 & \bf{0.179650} & dadi & PhoSin & Vaquita2Epoch\_1R22 & exons \\
\bf{0.022866} & 0.230358 & grapes & PhoSin & Vaquita2Epoch\_1R22 & exons \\
0.024026 & 0.205934 & polyDFE & PhoSin & Vaquita2Epoch\_1R22 & exons \\
\hline
\end{tabular}
\label{tab:dfe_table}
\end{table}
