...
\affil[10]{\small{The Jackson Laboratory, Bar Harbor, ME, 04609 USA}}
...
\affil[28]{\small{Department of Biology, Pennsylvania State University, University Park, PA 16802, USA}}
...
%    \end{figure}
    ...
    In comparing demography inference methods, we see that the site-frequency-based method (\stairway) produces more accurate
...
\section*{Discussion}
    ...
    Inference of the DFE was done here using exon annotations of the genome in question.
