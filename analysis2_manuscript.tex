...
\section*{Implementing Selection in \stdpopsim}
    ...
    genomic elements of the given annotation being modeled (e.g., CDS) are prioritized over overlapping annotations of other types (e.g., exons)
    and we do not currently support multiple overlapping annotations of different types. \revpoint{2}{1}
    ...
    and used to inform conservation efforts for this critically endangered species. \llabel{vaquita_note}
...
\section*{Discussion}
    ...
    %DRS: Is the limitatio here that selection coefficients are gamma-distributed, or rather that h is fixed?
...
\section*{Methods}
    ...
    which covers 2.1\% of the genome. \revpoint{2}{5}
    ...
    which covers 2.2\% of the genome. \llabel{vaquita_percent}
    ...
    See Figure \ref{fig:sim-sweeps-runtime} for the distribution of runtimes (in minutes) for the simulations of the 100 segments of human chromosome 1. \llabel{sim-sweeps-runtime}
