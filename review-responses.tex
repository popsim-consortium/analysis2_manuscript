...
\end{point}
  ...
  \reply{
    ...
    With respect to the sweep simulations, we show that the simulation of sweeps in each of the segments is takes approximately 3 minutes \llname{sim-sweeps-runtime}.
